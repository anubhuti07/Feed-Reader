...
$(function() {
    ...
    */
    describe("RSS Feeds", function() {
         ...
         */
        allFeeds.forEach(function(objname){
            it("has name", function() {
                expect(objname.name).toBeDefined();
                expect(objname.name.length).not.toBe(0);
            });
        });
    });
    ...
    describe("The menu", function(){
        ...
        /* A test to ensure that the menu changes
         * visibility when the menu icon is clicked.
         * expectation-1: The menu displays when
         * clicked.
         */
    ...
    describe("Initial Entries", function() {
        ...
        /* A test to ensures when the loadFeed
